...
export default function EmployeePage() {
  ...
  useEffect(() => {
    const fetchOtherEmployees = async () => {
      ...
      if (debouncedSearchTerm && debouncedSearchTerm.length >= 2) {
        ...
        if (error) {
          ...
          // Filter out current employee from results
          const filtered = (data || []).filter((emp: Employee) => emp.id !== id)
          setOtherEmployees(filtered)
          setTotalOthers(filtered.length)
        }
      } else {
    ...
    fetchOtherEmployees()
  }, [id, employee, currentPage, debouncedSearchTerm])
  ...
  const filteredOtherEmployees = otherEmployees
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div id="other-employees">
        ...
        <div className="relative">
          <input
            type="text"
            placeholder="Search other employees by name or department..."
            value={searchTerm}
